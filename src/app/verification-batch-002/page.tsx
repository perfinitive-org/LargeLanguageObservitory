...
export const metadata: Metadata = {
  title: "Verification Batch 002 | AI Native Observatory",
  description:
    "Scaled verification batch for five Observatory records using normalized evidence."
};

const batchRecords = [
  {
    observableId: "org-cerebras",
    decisionId: "verification-batch-002-cerebras-source-backed",
    category: "Organization",
    officialEvidenceIds: ["evidence-cerebras-official-company"],
    independentEvidenceIds: ["evidence-cerebras-time-profile"],
    findings: [
      "Organization exists",
      "Official source identified",
      "Independent company profile identified",
      "Description appears reasonable",
      "Relationships appear reasonable"
    ]
  },
  {
    observableId: "org-deepseek",
    decisionId: "verification-batch-002-deepseek-source-backed",
    category: "Organization",
    officialEvidenceIds: ["evidence-deepseek-official-website"],
    independentEvidenceIds: ["evidence-deepseek-ap-chinese-ai-models"],
    findings: [
      "Organization exists",
      "Official source identified",
      "Independent industry coverage identified",
      "Description appears reasonable",
      "Model relationship appears reasonable"
    ]
  },
  {
    observableId: "org-alibaba-cloud",
    decisionId: "verification-batch-002-alibaba-cloud-source-backed",
    category: "Organization",
    officialEvidenceIds: ["evidence-alibaba-cloud-official-about"],
    independentEvidenceIds: ["evidence-alibaba-cloud-techradar-ai-demand"],
    findings: [
      "Organization exists",
      "Official source identified",
      "Independent cloud industry coverage identified",
      "Description appears reasonable",
      "Model relationship appears reasonable"
    ]
  },
  {
    observableId: "dc-aws-northern-virginia",
    decisionId: "verification-batch-002-aws-northern-virginia-source-backed",
    category: "Infrastructure",
    officialEvidenceIds: ["evidence-aws-northern-virginia-official-regions"],
    independentEvidenceIds: [
      "evidence-northern-virginia-wapo-data-center-capital"
    ],
    findings: [
      "Infrastructure region exists",
      "Official AWS infrastructure source identified",
      "Independent regional infrastructure coverage identified",
      "Operator relationship appears reasonable",
      "No capacity or facility-specific claims were added"
    ]
  },
  {
    observableId: "dc-cerebras-condor-galaxy",
    decisionId: "verification-batch-002-cerebras-condor-galaxy-source-backed",
    category: "Infrastructure",
    officialEvidenceIds: ["evidence-cerebras-official-company"],
    independentEvidenceIds: ["evidence-cerebras-marketwatch-g42-profile"],
    findings: [
      "Infrastructure observable has official source support",
      "Independent infrastructure coverage identified",
      "Operator relationship appears reasonable",
      "Description remains conservative",
      "No capacity, tenancy, or location claims were added"
    ]
  }
];
...
export default function VerificationBatch002Page() {
  return (
        ...
        <div className="relative mx-auto grid max-w-7xl gap-8 px-5 py-12 lg:grid-cols-[minmax(0,1fr)_380px] lg:px-8 lg:py-14">
          <div className="max-w-3xl">
            ...
            <p className="mt-8 text-xs font-semibold uppercase text-[#8fb7cf]">
              Scaled verification batch
            </p>
            <h1 className="mt-3 text-3xl font-semibold leading-tight sm:text-4xl">
              Verification Batch 002.
            </h1>
            <p className="mt-4 text-base leading-7 text-slate-300">
              Five records were reviewed using the existing Observatory
              pipeline: official source, independent source, normalized
              evidence, review decision, and record-level status outcome.
            </p>
          </div>
