...
export const metadata: Metadata = {
  title: "Verification Batch 004 | AI Native Observatory",
  description:
...
const batchRecords = [
  {
    observableId: "dc-equinix-sv11",
    decisionId: "verification-batch-004-equinix-sv11-source-backed",
    category: "Infrastructure",
    officialEvidenceIds: ["evidence-equinix-sv11-official-facility"],
    independentEvidenceIds: ["evidence-equinix-sv11-datacenter-map"],
    findings: [
  ...
  {
    observableId: "dc-google-tpu-cloud",
    decisionId: "verification-batch-004-google-tpu-cloud-source-backed",
    category: "Infrastructure",
    officialEvidenceIds: ["evidence-google-tpu-official"],
    independentEvidenceIds: ["evidence-google-tpu-techradar-infrastructure"],
    findings: [
      "Distributed infrastructure record exists",
      "Official Google Cloud TPU documentation identified",
      "Independent AI infrastructure coverage identified",
      "Operator relationship appears reasonable",
      "No generation, performance, or capacity claims were added"
    ]
  },
  {
    observableId: "dc-google-council-bluffs",
    decisionId: "verification-batch-004-google-council-bluffs-source-backed",
    category: "Infrastructure",
    officialEvidenceIds: [
      "evidence-google-council-bluffs-official-location"
    ],
    independentEvidenceIds: [
      "evidence-google-council-bluffs-datacenter-map"
    ],
    findings: [
      "Data center record exists",
      "Official Google data-center location page identified",
      "Independent facility-directory corroboration identified",
      "Operator and location appear reasonable",
  ...
  {
    observableId: "dc-google-mayes-county",
    decisionId: "verification-batch-004-google-mayes-county-source-backed",
    category: "Infrastructure",
    officialEvidenceIds: ["evidence-google-mayes-county-official-location"],
    independentEvidenceIds: ["evidence-google-mayes-county-midamerica"],
    findings: [
      "Data center record exists",
      "Official Google data-center location page identified",
      "Independent regional infrastructure corroboration identified",
      "Operator and location appear reasonable",
      "No capacity, power, or tenancy claims were added"
    ]
  },
  {
    observableId: "dc-google-the-dalles",
    decisionId: "verification-batch-004-google-the-dalles-source-backed",
    category: "Infrastructure",
    officialEvidenceIds: ["evidence-google-the-dalles-official-location"],
    independentEvidenceIds: ["evidence-google-the-dalles-datacenter-map"],
    findings: [
      "Data center record exists",
      "Official Google data-center location page identified",
      "Independent facility-directory corroboration identified",
...
export default function VerificationBatch004Page() {
  return (
